...
class SeaConditions(BaseModel):
    ...
    surfaceTemperature: Optional[float] = Field(
        None, description='Sea surface temperature'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It has to be SeaConditions'
    )
    waveHeight: Optional[float] = Field(None, description='Height of the waves')
    waveLevel: Optional[confloat(ge=0.0, le=9.0)] = Field(
        None,
        description='It indicates the height of the waves and also measures the swell of the sea',
    )
    wavePeriod: Optional[float] = Field(
        None, description='Indicates the time between the crests of a wave'
    )
