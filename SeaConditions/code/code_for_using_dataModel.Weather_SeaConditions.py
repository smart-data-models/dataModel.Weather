...
dataModel = "SeaConditions"
subject = "dataModel.Weather"
dateObserved = "{'type': 'Property', 'value': '2021-02-20T06:45:00Z'}"
attribute = "dateObserved"
value = dateObserved
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

pH = {'type': 'Property', 'value': 8.5}
attribute = "pH"
value = pH
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

salinity = {'type': 'Property', 'value': 35}
attribute = "salinity"
value = salinity
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

surfaceTemperature = {'type': 'Property', 'value': 14.7}
